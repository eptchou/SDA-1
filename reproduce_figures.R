# =============================================================================
# Scientific Data Analysis (SDA) -- figure reproduction script
#
# Paper: "Scientific data analysis on hyperspectral functional data:
#         categorical exploratory data analysis (CEDA) coupled with
#         Kolmogorov's randomness-proper"
#
